...
export default async function AdminDashboardPage() {
  ...
  const cards = [
    ...
    { label: "Payments Pending", value: paymentsPendingRes.count ?? 0 },
    { label: "Payments Failed", value: paymentsFailedRes.count ?? 0 },
  ...
  const quickLinks = [
    ...
    { href: "/admin/payments", label: "Open Payments Console" },
